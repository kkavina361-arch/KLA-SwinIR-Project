...
output_path = r"D:\KLA_SwinIR_Project\results\comparison_L1_vs_L1SSIM_003159.png"
...
l1ssim = np.load(l1ssim_path).astype(np.float32)
...
# Clip restored images for display
